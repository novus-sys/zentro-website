        ...
        >
          <div
            className={cn(
              ...
              "after:[mask-composite:intersect] after:[mask:linear-gradient(#0000,#0000),conic-gradient(from_calc((var(--start)-(var(--spread)))*1deg),#00000000_0deg,#fff,#00000000_calc(var(--spread)*2deg))]"
            )}
          />
        </div>
      </>
