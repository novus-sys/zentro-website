...
// Enhanced CPPN shader - improved version of the original
const vertexShader = `
  varying vec2 vUv;
  void main() {
    vUv = uv;
...
const fragmentShader = `
  ...
  void main() {
    ...
    gl_FragColor = cppn_fn(uv, 0.08 * sin(0.25 * time), 0.08 * sin(0.55 * time), 0.08 * sin(0.35 * time));
  }
`;
...
export default function AnimatedBackground() {
  ...
  return (
    <div ref={canvasRef} className="bg-black fixed inset-0 -z-10 w-screen h-screen" aria-hidden="true">
      <Canvas
        camera={camera}
